...
from tenhodito_nlp import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('tenhodito-nlp')
...
def main(args=None):
    """
    Called with ``python -m tenhodito_nlp.tests``: run main test suite.
    """
    ...
    import tenhodito_nlp.tests as test_module
